...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    IF_TOKEN = 261,                /* IF_TOKEN  */
    ELSE_TOKEN = 262,              /* ELSE_TOKEN  */
    RETURN = 263,                  /* RETURN  */
    GREATER_THAN = 264,            /* GREATER_THAN  */
    LESS_THAN = 265,               /* LESS_THAN  */
    DOUBLE_EQ = 266,               /* DOUBLE_EQ  */
    LESS_THAN_EQUAL = 267,         /* LESS_THAN_EQUAL  */
    GREATER_THAN_EQUAL = 268,      /* GREATER_THAN_EQUAL  */
    CHECKNOT_EQUAL = 269,          /* CHECKNOT_EQUAL  */
    NUM = 270,                     /* NUM  */
    ID = 271,                      /* ID  */
    STRING = 272                   /* STRING  */
  };
